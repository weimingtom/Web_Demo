...
<%  
        ...
        ResultSet set2;
        String sql2="select * from xinshuguan where time between '"+startDate+"' and '"+endDate+"' order by time";
        conDB db = new conDB();  
        db.connectDB();  
        Statement state2 = db.getConnection().createStatement();
%>
...
<div class="main">
  <div class="main_container">
    ...
    <!--符合表达式要求的jsp语句-->
    <% 
            set2= state2.executeQuery(sql2);
            if(startDate.isEmpty()&endDate.isEmpty()||set2==null){
            	out.println("<tr class='null'><td colspan='4'>查询结果为空</td></tr>"); 
            }else{
            	while(set2.next())  
                { 
            	 out.println("<tr><td>"+set2.getString(1)+"</td><td>"+set2.getString(2)+"</td><td>"+set2.getString(3)+"</td><td>"+set2.getString(4)+"</td></tr>");  
                }
            }
